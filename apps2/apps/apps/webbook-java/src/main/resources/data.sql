...
INSERT INTO authors(name, dateOfBirth, dateOfDeath, description) VALUES
    ...
    ('Марк Твен', '1939', '1945', ''),
    ('Петров Андрей', '1988', '', 'Наивный парень, желавший с ноги ворваться в IT и столкнувшийся суровой правдой жизни'),
    ('С. Л. Клайв', '1939', '', '');
...
INSERT INTO books (name, genre_id, author_id, year,description, status) VALUES
                                                     ('Как сделать дипломную и не потерять рассудок', (SELECT id FROM genres WHERE name = 'Драма'), (SELECT id FROM authors WHERE name = 'Петров Андрей'), 2023, '', 'Свободна'),
